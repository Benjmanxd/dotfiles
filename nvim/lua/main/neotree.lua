...
local config = {
  ...
  source_selector = {
    ...
    statusline = false,
    sources = {
      { source = "filesystem",       display_name = utils.get_icon("FolderClosed") .. " File" },
      { source = "buffers",          display_name = utils.get_icon("DefaultFile") .. " Bufs" },
      { source = "git_status",       display_name = utils.get_icon("GitBranch") .. " Git" },
      { source = "document_symbols", display_name = utils.get_icon("Symbol") .. " Symbols" },
    },
