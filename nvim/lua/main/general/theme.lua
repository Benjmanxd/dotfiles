...
theme.base = {
  Normal = { fg = palette.blue_2, bg = palette.bg },
  ...
  Statement = { fg = palette.pink, bg = palette.none, style = { style.italic } },
  Conditional = { fg = palette.pink, bg = palette.none, style = { style.italic } },
  Repeat = { fg = palette.pink, bg = palette.none, style = { style.italic } },
  Label = { fg = palette.blue, bg = palette.none },
  Operator = { fg = palette.pink, bg = palette.none },
  Keyword = { fg = palette.pink, bg = palette.none, style = { style.italic } },
...
theme.bufferline = {
  ...
  BufferLineModifiedSelected = { fg = palette.green, bg = palette.bg, style = { style.bold, style.italic } },
  BufferLineError = { fg = palette.red_1, bg = palette.bg_1 },
  BufferLineErrorVisible = { fg = palette.red_1, bg = palette.bg_1 },
  BufferLineErrorSelected = { fg = palette.red_1, bg = palette.bg, style = { style.bold, style.italic } },
  ...
  BufferLineErrorDiagnosticSelected = { fg = palette.red_1, bg = palette.bg, style = { style.bold, style.italic } },
...
theme.neotree = {
  NeoTreeTabActive = { fg = palette.purple_statement, bg = palette.bg, style = { style.bold, style.italic } },
  NeoTreeTabInactive = { fg = "#777777", bg = "#141414" },
}
