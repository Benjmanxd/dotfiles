...
-- buffer navigation
vim.keymap.set("n", "<C-b>n", "<CMD>bnext<CR>", { desc = "[B]uffer [N]ext", noremap = true, silent = true })
vim.keymap.set("n", "<C-b>m", "<CMD>bprevious<CR>", { desc = "[B]uffer [P]revious", noremap = true, silent = true })
-- window navigation
